...
const style={
    ...
    borderRadius: "5px",
    color: "rgb(24 120 71)",
    backgroundColor: "rgb(76 255 159 / 12%)",
    marginBottom:"15px"
}
function AlertSuccess(props) {
    
  return (
    <div style={style} className="MuiPaper-root 
    ...
    MuiAlert-standard css-1u43w57" role="alert">
        ...
        <div className="MuiAlert-message css-1w0ym84">{props.texte} 
           <a href='' style={{marginLeft:"10px",marginRight:"10px"}}><b>x</b></a>
        </div>
    </div>
  )
}
